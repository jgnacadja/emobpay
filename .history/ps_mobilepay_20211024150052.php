...
class Ps_MobilePay extends PaymentModule
{
    ...
    public function hookPaymentOptions($params)
    {
        ...
        $newOption->setCallToActionText($this->trans('Paiement Mobile', array(), 'Modules.BankBNI.Shop'))
        ->setAction($this->context->link->getModuleLink($this->name, 'validation', array(), true))->setAdditionalInformation($this->context->smarty->fetch('module:bankbni/views/templates/hook/intro.tpl'));
